...
export class Calendar {
  ...
  private static readonly lunarMonthZH = ["正", "二", "三", "四", "五", "六", "七", "八", "九", "十", "冬", "腊"];
  private static readonly lunarDayZH = [
    "初一", "初二", "初三", "初四", "初五", "初六", "初七", "初八", "初九", "初十",
    "十一", "十二", "十三", "十四", "十五", "十六", "十七", "十八", "十九", "二十",
    "廿一", "廿二", "廿三", "廿四", "廿五", "廿六", "廿七", "廿八", "廿九", "三十"
  ];

  private static readonly festivals = {
    solar: {
      "01-01": ["元旦"],
      "02-14": ["情人节"],
      "03-08": ["妇女节"],
  ...
  private static getTerm(y: number, n: number): number {
    const termInfo = [
  ...
  // 获取公历月份的天数
  private static solarDays(y: number, m: number): number {
  ...
  // 获取节日
  private static getFestivals(month: number, day: number, lunarMonth: number, lunarDay: number): string[] {
